...
export RDI_DATADIR="/home/tcmichals/tools/Xilinx/Vivado/2024.2/data"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_16 -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_20 -L processing_system7_vip_v1_0_22 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot bare_design xil_defaultlib.bare_design xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim bare_design -key {Behavioral:sim_1:Functional:bare_design} -tclbatch cmd.tcl -protoinst "protoinst_files/bare_design.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/tcmichals/tools/Xilinx/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb bare_design.wdb xsim.dir libdpi.so)

...
design_libs=(xilinx_vip lib_cdc_v1_0_3 proc_sys_reset_v5_0_16 xil_defaultlib axi_infrastructure_v1_1_0 axi_vip_v1_1_20 processing_system7_vip_v1_0_22)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../bare_project.gen/sources_1/bd/bare_design/ipshared/ec67/hdl" +incdir+"../../../../bare_project.gen/sources_1/bd/bare_design/ipshared/8391/hdl" +incdir+"/home/tcmichals/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../bare_project.gen/sources_1/bd/bare_design/ipshared/ec67/hdl" +incdir+"../../../../bare_project.gen/sources_1/bd/bare_design/ipshared/8391/hdl" +incdir+"/home/tcmichals/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_vip_v1_1_20 $vlogan_opts -sverilog +incdir+"../../../../bare_project.gen/sources_1/bd/bare_design/ipshared/ec67/hdl" +incdir+"../../../../bare_project.gen/sources_1/bd/bare_design/ipshared/8391/hdl" +incdir+"/home/tcmichals/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../bare_project.gen/sources_1/bd/bare_design/ipshared/0f82/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work processing_system7_vip_v1_0_22 $vlogan_opts -sverilog +incdir+"../../../../bare_project.gen/sources_1/bd/bare_design/ipshared/ec67/hdl" +incdir+"../../../../bare_project.gen/sources_1/bd/bare_design/ipshared/8391/hdl" +incdir+"/home/tcmichals/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../bare_project.gen/sources_1/bd/bare_design/ipshared/8391/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../bare_project.gen/sources_1/bd/bare_design/ipshared/ec67/hdl" +incdir+"../../../../bare_project.gen/sources_1/bd/bare_design/ipshared/8391/hdl" +incdir+"/home/tcmichals/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.bare_design xil_defaultlib.glbl -o bare_design_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./bare_design_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/tcmichals/projects/home/zynq/microphase-z7lite/microphase-z7lite/vivado/bare_project/bare_project.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key bare_design_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc bare_design_simv.daidir vcs_lib c.obj)

...
#
# Script generated by Vivado on Tue Apr 01 15:16:49 CDT 2025
# SW Build 5266912 on Sun Dec 15 09:03:31 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : bare_design.sh
...
#
# Usage        : bare_design.sh
#                bare_design.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bare_design.sh [-reset_run]
#                bare_design.sh [-reset_log]
#                bare_design.sh [-help]
#
...
#                script (type 'bare_design.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname lib_cdc_v1_0_3 -libname proc_sys_reset_v5_0_16 -libname xil_defaultlib -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_20 -libname processing_system7_vip_v1_0_22 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip lib_cdc_v1_0_3 proc_sys_reset_v5_0_16 xil_defaultlib axi_infrastructure_v1_1_0 axi_vip_v1_1_20 processing_system7_vip_v1_0_22)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "bare_design.sh - Script generated by export_simulation (Vivado v2024.2.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bare_design.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../bare_project.gen/sources_1/bd/bare_design/ipshared/ec67/hdl" +incdir+"../../../../bare_project.gen/sources_1/bd/bare_design/ipshared/8391/hdl" +incdir+"/home/tcmichals/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../bare_project.gen/sources_1/bd/bare_design/ipshared/ec67/hdl" +incdir+"../../../../bare_project.gen/sources_1/bd/bare_design/ipshared/8391/hdl" +incdir+"/home/tcmichals/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_vip_v1_1_20 $xmvlog_opts -sv +incdir+"../../../../bare_project.gen/sources_1/bd/bare_design/ipshared/ec67/hdl" +incdir+"../../../../bare_project.gen/sources_1/bd/bare_design/ipshared/8391/hdl" +incdir+"/home/tcmichals/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../bare_project.gen/sources_1/bd/bare_design/ipshared/0f82/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work processing_system7_vip_v1_0_22 $xmvlog_opts -sv +incdir+"../../../../bare_project.gen/sources_1/bd/bare_design/ipshared/ec67/hdl" +incdir+"../../../../bare_project.gen/sources_1/bd/bare_design/ipshared/8391/hdl" +incdir+"/home/tcmichals/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../bare_project.gen/sources_1/bd/bare_design/ipshared/8391/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../bare_project.gen/sources_1/bd/bare_design/ipshared/ec67/hdl" +incdir+"../../../../bare_project.gen/sources_1/bd/bare_design/ipshared/8391/hdl" +incdir+"/home/tcmichals/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.bare_design xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.bare_design -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/tcmichals/projects/home/zynq/microphase-z7lite/microphase-z7lite/vivado/bare_project/bare_project.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log bare_design_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bare_design.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bare_design.sh [-help]\n\
Usage: bare_design.sh [-step]\n\
Usage: bare_design.sh [-lib_map_path]\n\
Usage: bare_design.sh [-reset_run]\n\
Usage: bare_design.sh [-reset_log]\n\
Usage: bare_design.sh [-keep_index]\n\
Usage: bare_design.sh [-noclean_files]\n\n\
